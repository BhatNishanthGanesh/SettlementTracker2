                  ...
                  <div className="border-t border-emerald-200/30 dark:border-emerald-700/30 pt-2">
                    ...
                    <div className="flex items-center justify-between mt-2 text-xs">
                      ...
                      <span className="font-medium text-emerald-600 dark:text-emerald-400">
                        {Object.keys(splits).length} people
                      </span>
                    </div>
                    <div className="mt-2 space-y-1">
                      {Object.entries(splits).map(
                        ([memberId, splitAmount], index) => (
                          <div
                            key={memberId}
                            className="flex items-center justify-between text-xs"
                          >
                            <span className="text-gray-600 dark:text-gray-300">
                              {splitBetween[index] || "Unknown"}
                            </span>
          ...
          {canEditOrDelete && (
            <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-48 dark:bg-gray-900 bg-white border dark:border-gray-700"
                >
                  ...
                  {/* Text AND image messages can be deleted */}
                  <DropdownMenuItem
