// app/expenses/constants/category.constants.ts
import { Plane, Car, Hotel, Utensils, Activity, ShoppingBag, Film, Ticket, CreditCard } from 'lucide-react';
...
export const getCategoryIcon = (category?: string | null) => {
  return categoryIcons[category?.toLowerCase() || 'other'] || CreditCard;
};

export const getCategoryColor = (category?: string | null) => {
  return categoryColors[category?.toLowerCase() || 'other'] || 'from-gray-500 to-gray-600';
};